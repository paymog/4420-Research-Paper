	...
	\section{Results}
		\subsection{Mass Comparison}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{AllthePlotsSmallScale_comp.png}
					\includegraphics<2>[width=95mm]{AllthePlotsSmallScale_swap.png}
				\end{center}
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{AllthePlotsLargeScale_comp.png}
					\includegraphics<2>[width=95mm]{AllthePlotsLargeScale_swap.png}
				\end{center}
				\note{
					Comparisons :
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{SemilogxAllPlotsLargeScale_comp.png}
					\includegraphics<2>[width=95mm]{SemilogxAllPlotsLargeScale_swap.png}
				\end{center}
				\note{
		...
		\subsection{One Pivot}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{OnePivotsSmallScale_comp.png}
					\includegraphics<2>[width=95mm]{OnePivotsSmallScale_swap.png}
				\end{center}
				\note{
					Comparisons :
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{OnePivotsLargeScale_comp.png}
					\includegraphics<2>[width=95mm]{OnePivotsLargeScale_swap.png}
				\end{center}
				\note{
					Comparisons :
		...
		\subsection{Two Pivots}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{TwoPivotsSmallScale_comp.png}
					\includegraphics<2>[width=95mm]{TwoPivotsSmallScale_swap.png}
				\end{center}
				\note{
					Comparisons :
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{TwoPivotsLargeScale_comp.png}
					\includegraphics<2>[width=95mm]{TwoPivotsLargeScale_swap.png}
				\end{center}
				\note{
					Comparisons :
		...
		\subsection{Three Pivots}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{ThreePivotsSmallScale_comp.png}
					\includegraphics<2>[width=95mm]{ThreePivotsSmallScale_swap.png}
				\end{center}
				\note{
					Comparisons :
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{ThreePivotsLargeScale_comp.png}
					\includegraphics<2>[width=95mm]{ThreePivotsLargeScale_swap.png}	
				\end{center}
				\note{
					Comparisons :
		...
		\subsection{M Pivots}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{M-PivotQuicksortsSmallScale_comp.png}
					\includegraphics<2>[width=95mm]{M-PivotQuicksortsSmallScale_swap.png}
				\end{center}
				\note{
					Comparisons :
						3-pivot sort rocks.
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=95mm]{M-PivotQuicksortsLargeScale_comp.png}
					\includegraphics<2>[width=95mm]{M-PivotQuicksortsLargeScale_swap.png}
				\end{center}
				\note{
					Comparisons :
						3,4,5-pivot sort are really good.
		...
		\subsection{Polynomial Fit}
			\begin{frame}
				\frametitle{Fit Coefficients of $A n \log(n) + B n + C \log(n)$ }
				\only<1>{
					\begin{center}
						\begin{tabular}{|r|c|c|}
							\hline
