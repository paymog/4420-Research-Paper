	...
	\section{Results}
		\subsection{Mass Comparison}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{AllthePlotsSmallScale_comp.png}
				\end{center}
				...
				\begin{center}   
					\includegraphics<2>[width=80mm]{AllthePlotsSmallScale_swap.png}
				\end{center}
				\note{
					Swaps :
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{AllthePlotsLargeScale_comp.png}
					\includegraphics<2>[width=80mm]{AllthePlotsLargeScale_swap.png}
				\end{center}
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{SemilogxAllPlotsLargeScale_comp.png}
					\includegraphics<2>[width=80mm]{SemilogxAllPlotsLargeScale_swap.png}
				\end{center}
		...
		\subsection{One Pivot}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{OnePivotsSmallScale_comp.png}
					\includegraphics<2>[width=80mm]{OnePivotsSmallScale_swap.png}
				\end{center}
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{OnePivotsLargeScale_comp.png}
					\includegraphics<2>[width=80mm]{OnePivotsLargeScale_swap.png}
				\end{center}
		...
		\subsection{Two Pivots}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{TwoPivotsSmallScale_comp.png}
					\includegraphics<2>[width=80mm]{TwoPivotsSmallScale_swap.png}
				\end{center}
			\end{frame}
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{TwoPivotsLargeScale_comp.png}
					\includegraphics<2>[width=80mm]{TwoPivotsLargeScale_swap.png}
				\end{center}
			\end{frame}
		...
		\subsection{Three Pivots}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{ThreePivotsSmallScale_comp.png}
					\includegraphics<2>[width=80mm]{ThreePivotsSmallScale_swap.png}
				\end{center}
			\end{frame}
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{ThreePivotsLargeScale_comp.png}
					\includegraphics<2>[width=80mm]{ThreePivotsLargeScale_swap.png}	
				\end{center}
			\end{frame}
		...
		\subsection{M Pivots}
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{M-PivotQuicksortsSmallScale_comp.png}
					\includegraphics<2>[width=80mm]{M-PivotQuicksortsSmallScale_swap.png}
				\end{center}
			\end{frame}
			...
			\begin{frame}
				...
				\begin{center}   
					\includegraphics<1>[width=80mm]{M-PivotQuicksortsLargeScale_comp.png}
					\includegraphics<2>[width=80mm]{M-PivotQuicksortsLargeScale_swap.png}
				\end{center}
